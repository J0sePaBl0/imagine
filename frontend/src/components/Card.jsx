...
export function Card(props) {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="my-5 mt-20 md:my-10 flex group border border-blue-800 md:flex-row relative w-70 h-auto overflow-hidden rounded-[16px] bg-gray-300 p-[1px] transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500"
